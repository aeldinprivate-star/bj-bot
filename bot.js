...
function getAction(p, d, afterSplit) {
  ...
  if(!afterSplit && pair){
    const pv=CV[p[0]];
    if(pv===11) return {a:"SPLIT",e:"✂️",l:"Split",r:""};
    if(pv===8)  return {a:"SPLIT",e:"✂️",l:"Split",r:""};
    if(pv===10) return {a:"STAND",e:"🛑",l:"Stand",r:""};
    if(pv===9){ if([7,10,11].includes(dv)) return {a:"STAND",e:"🛑",l:"Stand",r:`9-9 vs ${d}: your 18 is enough here.`}; return {a:"SPLIT",e:"✂️",l:"Split",r:""}; }
    if(pv===7){ if(dv<=7) return {a:"SPLIT",e:"✂️",l:"Split",r:""}; return {a:"HIT",e:"🃏",l:"Hit",r:""}; }
    if(pv===6){ if(dv<=6) return {a:"SPLIT",e:"✂️",l:"Split",r:""}; return {a:"HIT",e:"🃏",l:"Hit",r:""}; }
    if(pv===5) return {a:"DOUBLE",e:"⬆️",l:"Double",r:""};
    if(pv===4){ if([5,6].includes(dv)) return {a:"SPLIT",e:"✂️",l:"Split",r:""}; return {a:"HIT",e:"🃏",l:"Hit",r:""}; }
  ...
  if(!afterSplit && soft && p.length===2){
    ...
    if(nv===9) return {a:"STAND",e:"🛑",l:"Stand",r:""};
    if(nv===8){ if(dv===6) return {a:"DOUBLE",e:"⬆️",l:"Double",r:""}; return {a:"STAND",e:"🛑",l:"Stand",r:""}; }
    if(nv===7){ if([3,4,5,6].includes(dv)) return {a:"DOUBLE",e:"⬆️",l:"Double",r:""}; if([2,7,8].includes(dv)) return {a:"STAND",e:"🛑",l:"Stand",r:""}; return {a:"HIT",e:"🃏",l:"Hit",r:""}; }
    if(nv===6){ if([3,4,5,6].includes(dv)) return {a:"DOUBLE",e:"⬆️",l:"Double",r:""}; return {a:"HIT",e:"🃏",l:"Hit",r:""}; }
    ...
    if([5,6].includes(dv)) return {a:"DOUBLE",e:"⬆️",l:"Double",r:""};
    return {a:"HIT",e:"🃏",l:"Hit",r:""};
  }
  if(t>=17) return {a:"STAND",e:"🛑",l:"Stand",r:""};
  if(t<=8)  return {a:"HIT",e:"🃏",l:"Hit",r:""};
  if(!afterSplit && t===11) return {a:"DOUBLE",e:"⬆️",l:"Double",r:""};
  if(!afterSplit && t===10){ if(dv<=9) return {a:"DOUBLE",e:"⬆️",l:"Double",r:""}; return {a:"HIT",e:"🃏",l:"Hit",r:""}; }
  if(!afterSplit && t===9){ if([3,4,5,6].includes(dv)) return {a:"DOUBLE",e:"⬆️",l:"Double",r:""}; return {a:"HIT",e:"🃏",l:"Hit",r:""}; }
  if(t===16){ if(dv>=7) return {a:"HIT",e:"🃏",l:"Hit",r:""}; return {a:"STAND",e:"🛑",l:"Stand",r:""}; }
  if(t===15){ if(dv>=7) return {a:"HIT",e:"🃏",l:"Hit",r:""}; return {a:"STAND",e:"🛑",l:"Stand",r:""}; }
  if(t===12){ if([4,5,6].includes(dv)) return {a:"STAND",e:"🛑",l:"Stand",r:""}; return {a:"HIT",e:"🃏",l:"Hit",r:""}; }
